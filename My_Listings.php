  ...
  <div class="Nav-container" id="Nav-container">
    <nav class="navbar navbar-expand-lg fixed-top" data-bs-theme="light" style="background: linear-gradient(to right, #5c6bc0, #512da8);">
      <div class="container-fluid">
        <a class="navbar-brand" href="Lost-Listing.php" style="color:white;">SoccaLinkUp</a>
...
<!-- // error_reporting(0); -->
 ...
 <h1 class="high">My Listing Items </h1>
<!-- <div class="card">  -->
  <?php while ($row = mysqli_fetch_assoc($sql)) { ?>
    ...
    <div class="image-container">
      ...
      <center>
        ...
        <a href='delete_desing2.php?id=<?= htmlspecialchars($row["id"])?>'><input type="submit" value="delete" class="delete btn" onclick = 'return checkdelete()'></a> 
